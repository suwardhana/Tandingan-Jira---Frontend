            ...
            {tasks.map((task) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <span className="inline-flex items-center whitespace-nowrap rounded border border-gray-200 bg-slate-100 px-2.5 py-0.5 text-xs font-medium text-slate-700 dark:border-gray-700 dark:bg-slate-800 dark:text-slate-300">
                      {task.status}
                    </span>
                  </td>
                  <td className="px-4 py-3">
