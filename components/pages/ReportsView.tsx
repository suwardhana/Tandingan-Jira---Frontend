      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-border dark:bg-dark-surface">
          <div className="mb-4 flex items-center justify-between">
            ...
            <span className="rounded-full bg-green-100 px-2 py-1 text-xs font-bold text-green-600 dark:bg-green-900/30 dark:text-green-400">
              --
            </span>
          </div>
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Sprint Velocity</p>
          <h3 className="mt-1 text-3xl font-bold text-slate-900 dark:text-white">{velocity} pts</h3>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-border dark:bg-dark-surface">
          <div className="mb-4 flex items-center justify-between">
          ...
          <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Active Bugs</p>
          <h3 className="mt-1 text-3xl font-bold text-slate-900 dark:text-white">{activeBugs}</h3>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-border dark:bg-dark-surface">
          <div className="mb-4 flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-border dark:bg-dark-surface lg:col-span-2">
          <div className="mb-6 flex items-center justify-between">
            ...
            <select className="rounded-md border-none bg-gray-100 px-3 py-1 text-xs text-slate-700 focus:ring-0 dark:bg-dark-bg dark:text-slate-300">
              {sprints.map((s) => (
        ...
        <div className="flex flex-col rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-dark-border dark:bg-dark-surface">
          ...
          <div className="relative flex flex-1 items-center justify-center">
            <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-xs uppercase text-slate-500 dark:text-slate-400">Total</span>
            </div>
