    ...
    <div className="px-6 pb-6 h-full overflow-y-auto custom-scrollbar max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-end pt-4">
            <button className="px-6 py-2 bg-jira-blue text-white rounded-md font-semibold hover:bg-jira-blue-hover shadow-lg shadow-blue-500/20 transition-all">
                Save Changes
            </button>
        </div>
      </div>
