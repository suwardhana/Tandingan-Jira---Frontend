          ...
          <div key={user.id} className="bg-white dark:bg-dark-surface rounded-xl border border-gray-200 dark:border-dark-border p-6 shadow-sm hover:shadow-md transition-shadow">
            <div className="flex flex-col items-center text-center">
              <div className="relative mb-4">
                <img src={user.avatar} alt={user.name} className="size-20 rounded-full object-cover border-4 border-gray-50 dark:border-dark-bg" />
              ...
              {/* Removed Profile and Message buttons as requested */}
            </div>
          </div>
        ))}
      </div>
