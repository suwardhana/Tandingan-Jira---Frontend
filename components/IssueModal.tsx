...
import { Task, User, Priority, Status, Comment, IssueType } from '../types';
                        ...
                        {activeTab === 'comments' ? (
                            <>
                                    ...
                                    {task.comments?.map(comment => {
                                        ...
                                        return (
                                            <div key={comment.id} className="flex gap-3">
                                                <img src={commentUser?.avatar} alt="" className="size-8 rounded-full flex-shrink-0" />
                                ...
                                <div className="flex gap-3">
                                    <img src={currentUser.avatar} alt="" className="size-8 rounded-full flex-shrink-0" />
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-[100px_1fr] items-center gap-2">
                            ...
                            <div className="relative">
                                ...
                                {assignee ? (
                                    <img src={assignee.avatar} className="size-5 rounded-full absolute left-2.5 top-2 pointer-events-none border border-gray-200 dark:border-gray-700" alt="" />
                                ) : (
                        ...
                        <div className="grid grid-cols-[100px_1fr] items-center gap-2">
                            ...
                            <div className="relative">
                                <select 
                                    ...
                                    className="w-full pl-8 py-1.5 bg-transparent hover:bg-slate-200/50 dark:hover:bg-slate-700/50 rounded-md border-transparent focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm text-slate-700 dark:text-slate-300 cursor-pointer appearance-none"
                                >
                                    {Object.values(Priority).map(p => <option key={p} value={p}>{p}</option>)}
                                </select>
                                <span className={`material-symbols-outlined text-lg absolute left-1.5 top-1.5 pointer-events-none ${getPriorityColor(task.priority)}`}>flag</span>
                            </div>
                        </div>
